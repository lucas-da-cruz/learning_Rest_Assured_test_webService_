package br.com.leilao.modelo;

import javax.xml.bind.annotation.XmlRootElement;

/**
 * Essa é uma anotação da especificação JAX-B, que fala sobre XML, usado pelo Rest-Assured.
 * Toda classe que você serializa e desserializa deve ser anotada com isso.
 * Você pode fazer uso das outras anotações da especificação, para customizar seu XML.
 */
@XmlRootElement
public class Leilao {
